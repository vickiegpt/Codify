// ane_bridge.m — Objective-C implementation of ANE bridge
// Adapted from ~/Downloads/ANE for iOS integration in Codify
...
int ane_bridge_init(void) {
    ...
    // On iOS, the framework path is different from macOS
    void *handle = dlopen(
        "/System/Library/PrivateFrameworks/AppleNeuralEngine.framework/AppleNeuralEngine",
        RTLD_NOW);
    if (!handle) {
        // Try alternative iOS path
        handle = dlopen(
    ...
    int n_outputs, const size_t *output_sizes)
{
    @autoreleasepool {
        ...
        // Pre-populate temp dir with MIL + weight files
